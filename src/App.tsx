    ...
    coding: [
      ...
      { 
        ...
        problems: [
          ...
          { name: 'CodeChef - Beginner', url: 'https://www.codechef.com/practice' }
        ]
      },
      { 
        id: 'c4', 
        ...
        problems: [
          ...
          { name: 'LeetCode - Loop Problems', url: 'https://leetcode.com/tag/array/' }
        ]
      },
      { 
        id: 'c5', 
      ...
      { 
        ...
        problems: [
          ...
          { name: 'HackerRank - Arrays', url: 'https://www.hackerrank.com/domains/data-structures' }
        ]
      },
      { 
        id: 'c7', 
        ...
        problems: [
          { name: 'HackerRank - Strings', url: 'https://www.hackerrank.com/domains/python' },
